...
public class RespuestaContollerListarTest {
    ...
    @Test
    void deberiaListarRespuestasPorTopico() throws Exception {
        ...
        when(respuestaService.listarPorTopico(2L))
                .thenReturn(List.of(r1));

        mockMvc.perform(get("/respuestas/topico/2"))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$[0].contenido").value("respuesta 1"));
    }
}
