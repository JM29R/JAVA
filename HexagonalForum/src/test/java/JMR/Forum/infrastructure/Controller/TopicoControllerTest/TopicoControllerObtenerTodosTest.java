...
class TopicoControllerObtenerTodosTest {
    ...
    void deberiaListarTopicos() throws Exception {
        ...
        TopicoResponse t1 = new TopicoResponse(1L, "titulo1", "mensaje1", 2L);

        when(topicoService.buscarTodos()).thenReturn(List.of(t1));

        mockMvc.perform(get("/topicos/todos"))
